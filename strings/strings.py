...
stringContains = "out" in mainString
...
foundSubstringIndex = findSubstring.index("best")
...
#
###################### YOUR CODE BELOW THIS LINE #######################
lowercaseconv1 = checkEqualityIgnoreCase1.casefold()
lowercaseconv2 = checkEqualityIgnoreCase2.casefold()

stringsAreEqualIgnoreCase = lowercaseconv1 == lowercaseconv2
